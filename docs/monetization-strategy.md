...
Related: [`platform-engagement-strategy.md`](./platform-engagement-strategy.md) (why scores must mean something), [`build-principles.md`](./build-principles.md) (do not add star knobs before the lesson works on a phone), [`component-library-100.md`](./component-library-100.md) (what makes clubs more willing to pay — not a SKU), and [`org-cohort-model.md`](./org-cohort-model.md) (how clubs, seats, cohorts, and one-account multi-org membership should sit on the current stack).
