                        ...
                        <div className="space-y-3">
                            <div className="flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-1.5">
                                    ...
                                    <button
                                        ...
                                        className="text-[11px] font-extrabold text-slate-700 hover:text-[#58CC02] flex items-center gap-1 bg-slate-100 hover:bg-[#EDF9E0] px-2.5 py-1 rounded-lg transition-colors border border-slate-200"
                                    >
                                        <Upload className="w-3 h-3 text-[#58CC02]" /> Upload
                                    </button>
                                    <button
                                        type="button"
                            ...
                            <div className="relative">
                                <Input
                                    ...
                                    className="h-9 text-xs font-medium border-2 border-slate-200 focus-visible:ring-0 focus-visible:border-[#58CC02] rounded-xl bg-slate-50/50 pr-8"
                                />
                                {imageUrl && (
                                    <button
                                        type="button"
