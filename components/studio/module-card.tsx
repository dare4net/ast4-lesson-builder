...
export function ModuleCard({ module, onClick, onDelete }: ModuleCardProps) {
    return (
        ...
        >
            <div className="relative h-full bg-white border-2 border-slate-200 rounded-2xl overflow-hidden transition-all duration-200 hover:border-[#58CC02]/40 hover:-translate-y-0.5 hover:shadow-md shadow-sm">
                {/* Top accent bar */}
