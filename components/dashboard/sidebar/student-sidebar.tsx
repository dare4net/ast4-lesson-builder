                ...
                {!isCollapsed && (
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-[10px] font-semibold text-green-600 dark:text-green-400">Student Portal</span>
                        </div>
                    </div>
                )}
                    ...
                    return (
                        <Link key={item.href} href={item.href}>
                            <div className={cn(
                                ...
                                isActive
                                    ? "bg-green-50 dark:bg-green-500/10 text-green-600 dark:text-green-400 font-semibold"
                                ...
                                {isActive && (
                                    <motion.div
                                        ...
                                        className="absolute left-0 w-1 h-5 bg-green-500 rounded-r-full"
                                    />
                                )}

                                <item.icon className={cn(
                                    "w-5 h-5 shrink-0 transition-colors",
                                    isActive ? "text-green-500" : "text-slate-400 group-hover:text-slate-600 dark:group-hover:text-slate-300"
                                )} />
            ...
            <div className={cn(
                ...
                {!isCollapsed ? (
                    <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-900/50 border border-slate-200/60 dark:border-slate-800 flex items-center gap-3">
                        <div className="w-8 h-8 rounded-lg bg-green-100 dark:bg-green-500/20 text-green-600 dark:text-green-400 flex items-center justify-center font-bold text-xs">
