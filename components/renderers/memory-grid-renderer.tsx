                    ...
                    return (
                        <div
                            ...
                            className={cn(
                                ...
                                !isMatched && isFlipped && isTerm && "bg-[#1CB0F6] text-white border-[#1CB0F6] border-b-[#0090CC] shadow-[0_0_0_3px_#1CB0F6,0_4px_16px_rgba(28,176,246,0.35)]",
                                !isMatched && isFlipped && !isTerm && "bg-[#FFC800] text-slate-900 border-[#FFC800] border-b-amber-600 shadow-[0_0_0_3px_#FFC800,0_4px_16px_rgba(255,200,0,0.35)]",
