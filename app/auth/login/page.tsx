...
import { Mail, Lock, Loader2, ArrowRight, GraduationCap, BookOpenCheck } from 'lucide-react';
            ...
            <div className="p-8">
                ...
                <div className="flex flex-col items-center gap-3 mb-7">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-slate-500 text-xs font-medium mt-0.5">Sign in to access your workspace</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="space-y-1.5">
                        <div className="flex items-center justify-between">
                            ...
                            <Link href="#" className="text-xs font-semibold hover:underline" style={{ color: accent }}>Forgot password?</Link>
                        </div>
                        <div className="relative">
                    ...
                    <div className="pt-3 border-t border-slate-100 text-center">
                        <p className="text-xs text-slate-500 font-medium">
                            ...
                            <Link href={`/auth/signup?role=${role}`} className="font-bold hover:underline" style={{ color: accent }}>
                                Create an Account
                            </Link>
                        </p>
                    </div>
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col items-center justify-center px-4 relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
                <div className="absolute top-1/3 left-1/4 w-[40%] h-[40%] bg-[#1CB0F6]/5 rounded-full blur-[100px]" />
                <div className="absolute bottom-1/3 right-1/4 w-[40%] h-[40%] bg-[#58CC02]/5 rounded-full blur-[100px]" />
            </div>
            ...
            <p className="mt-6 text-[11px] font-medium text-slate-400">
                After-School Tech Studio • Secure Login
            </p>
        </div>
    );
}
