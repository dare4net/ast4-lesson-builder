...
describe('W5 richer component events', () => {
    ...
    it('widens the mobile search panel and gives inbox types icons', () => {
        ...
        expect(read('lib/inbox-icons.tsx')).toContain('CLASS_POLL_LIVE')
        expect(read('lib/inbox-icons.tsx')).toContain('CLASS_CLOUD_LIVE')
        expect(read('lib/inbox-icons.tsx')).toContain('CLASS_SCALE_LIVE')
        expect(read('lib/inbox-icons.tsx')).toContain('CLASS_ACTIVITY')
        expect(read('lib/inbox-icons.tsx')).toContain('NEXT_LESSON_UNLOCKED')
        expect(read('lib/inbox-icons.tsx')).toContain('TUTOR_MARKED')
    })
})
